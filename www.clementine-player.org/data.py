...
DOWNLOADS = [
  {'os': 'ubuntu',      'ver': '1.2', 'arch': 32, 'name': 'clementine_1.2.1~lucid_i386.deb'},
  {'os': 'ubuntu',      'ver': '1.2', 'arch': 64, 'name': 'clementine_1.2.1~lucid_amd64.deb'},
  {'os': 'uprecise',    'ver': '1.2', 'arch': 32, 'name': 'clementine_1.2.1~precise_i386.deb'},
  {'os': 'uprecise',    'ver': '1.2', 'arch': 64, 'name': 'clementine_1.2.1~precise_amd64.deb'},
  {'os': 'uquantal',    'ver': '1.2', 'arch': 32, 'name': 'clementine_1.2.1~quantal_i386.deb'},
  {'os': 'uquantal',    'ver': '1.2', 'arch': 64, 'name': 'clementine_1.2.1~quantal_amd64.deb'},
  {'os': 'uraring',     'ver': '1.2', 'arch': 32, 'name': 'clementine_1.2.1~raring_i386.deb'},
  {'os': 'uraring',     'ver': '1.2', 'arch': 64, 'name': 'clementine_1.2.1~raring_amd64.deb'},
  {'os': 'usaucy',      'ver': '1.2', 'arch': 32, 'name': 'clementine_1.2.1~saucy_i386.deb'},
  {'os': 'usaucy',      'ver': '1.2', 'arch': 64, 'name': 'clementine_1.2.1~saucy_amd64.deb'},
  {'os': 'wheezy',      'ver': '1.2', 'arch': 32, 'name': 'clementine_1.2.1~wheezy_i386.deb'},
  {'os': 'wheezy',      'ver': '1.2', 'arch': 64, 'name': 'clementine_1.2.1~wheezy_amd64.deb'},
  {'os': 'squeeze',     'ver': '1.2', 'arch': 32, 'name': 'clementine_1.2.1~squeeze_i386.deb'},
  {'os': 'squeeze',     'ver': '1.2', 'arch': 64, 'name': 'clementine_1.2.1~squeeze_amd64.deb'},
  {'os': 'fedora18',    'ver': '1.2', 'arch': 32, 'name': 'clementine-1.2.1-1.fc18.i686.rpm'},
  {'os': 'fedora18',    'ver': '1.2', 'arch': 64, 'name': 'clementine-1.2.1-1.fc18.x86_64.rpm'},
