...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb='\n.google/protobuf/internal/more_extensions.proto\x12\x18googlepb.protobuf.internal\"P\n\x0fTopLevelMessage\x12=\n\nsubmessage\x18\x01 \x01(\x0b\x32).googlepb.protobuf.internal.ExtendedMessage\"\x1b\n\x0f\x45xtendedMessage*\x08\x08\x01\x10\x80\x80\x80\x80\x02\"-\n\x0e\x46oreignMessage\x12\x1b\n\x13\x66oreign_message_int\x18\x01 \x01(\x05:I\n\x16optional_int_extension\x12).googlepb.protobuf.internal.ExtendedMessage\x18\x01 \x01(\x05:w\n\x1aoptional_message_extension\x12).googlepb.protobuf.internal.ExtendedMessage\x18\x02 \x01(\x0b\x32(.googlepb.protobuf.internal.ForeignMessage:I\n\x16repeated_int_extension\x12).googlepb.protobuf.internal.ExtendedMessage\x18\x03 \x03(\x05:w\n\x1arepeated_message_extension\x12).googlepb.protobuf.internal.ExtendedMessage\x18\x04 \x03(\x0b\x32(.googlepb.protobuf.internal.ForeignMessage')


OPTIONAL_INT_EXTENSION_FIELD_NUMBER = 1
optional_int_extension = _descriptor.FieldDescriptor(
  name='optional_int_extension', full_name='googlepb.protobuf.internal.optional_int_extension', index=0,
...
optional_message_extension = _descriptor.FieldDescriptor(
  name='optional_message_extension', full_name='googlepb.protobuf.internal.optional_message_extension', index=1,
...
repeated_int_extension = _descriptor.FieldDescriptor(
  name='repeated_int_extension', full_name='googlepb.protobuf.internal.repeated_int_extension', index=2,
...
repeated_message_extension = _descriptor.FieldDescriptor(
  name='repeated_message_extension', full_name='googlepb.protobuf.internal.repeated_message_extension', index=3,
...
_TOPLEVELMESSAGE = _descriptor.Descriptor(
  ...
  full_name='googlepb.protobuf.internal.TopLevelMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='submessage', full_name='googlepb.protobuf.internal.TopLevelMessage.submessage', index=0,
...
_EXTENDEDMESSAGE = _descriptor.Descriptor(
  ...
  full_name='googlepb.protobuf.internal.ExtendedMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_FOREIGNMESSAGE = _descriptor.Descriptor(
  name='ForeignMessage',
  full_name='googlepb.protobuf.internal.ForeignMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='foreign_message_int', full_name='googlepb.protobuf.internal.ForeignMessage.foreign_message_int', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
class TopLevelMessage(_message.Message):
  ...
  # @@protoc_insertion_point(class_scope:googlepb.protobuf.internal.TopLevelMessage)

class ExtendedMessage(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _EXTENDEDMESSAGE

  # @@protoc_insertion_point(class_scope:googlepb.protobuf.internal.ExtendedMessage)

class ForeignMessage(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _FOREIGNMESSAGE

  # @@protoc_insertion_point(class_scope:googlepb.protobuf.internal.ForeignMessage)
